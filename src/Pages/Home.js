...
const Home = () => {
    return (
        <>
            ...
            {/* Advantages Of Walk-In Showers section */}
            <section className='section-bg'>
                <div className='title-Advantages'>Advantages Of Walk-In Showers</div>
                <div className='container-box'>
                    <div className='cart'>
                        <div className='point'><span></span></div>
                        <div className='text'>
                        <h1>Warm & Comfortable</h1>
                        <p>Walk-in showers help keep you warm since water flows only when you turn on the shower. 
                        No need to sit and wait in the tub for it to fill or drain.</p>
                        </div>
                    </div>
                    <div className='cart'>
                        <div className='point'><span></span></div>
